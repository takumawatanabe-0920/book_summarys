import iconUl from '../../static/images/icon/list-ul-solid.svg';
import iconOl from '../../static/images/icon/list-ol-solid.svg';
...
export { iconUl, iconOl, editIcon, userCircleIcon, caretDownIcon, logoIcon };
